...
let lastNames = employees.map((idx) => idx.LastName); // [ 'Adams', 'Edwards', 'Peacock', 'Park', 'Johnson', 'Mitchell', 'King', 'Callahan' ]
let sortedLastNames = lastNames.sort(); // [ 'Adams', 'Callahan', 'Edwards', 'Johnson', 'King', 'Mitchell', 'Park', 'Peacock' ]

let employeeAge = employees
  .map((idx) => new Date(idx.BirthDate).toDateString().split(" ")[3] * 1 - 2023)
  .map((idx) => idx * -1);
